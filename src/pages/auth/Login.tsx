...
import { CustomInput, AppButton, AppLoader } from "../../components/dashboard";
...
const LoginPage = () => {
  ...
  return (
    <>
      <AppLoader open={isPending} title="Processing…" />
      <Box
        sx={{
          width: "100%",
          height: "100vh",
            ...
            >
              ...
              <Stack gap={2} mb="10px">
                <CustomInput
                  ...
                  type="text"
                  endIcon={
                    <VerifiedUser sx={{ color: ColorPallete.primary.main }} />
                  }
                  value={username}
                ...
                {[
                  {
                    ...
                    icon: (
                      <GoogleIcon sx={{ fontSize: 18, color: "#4285F4" }} />
                    ),
                  },
                  {
